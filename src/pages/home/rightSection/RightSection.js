            ...
            >
              ...
              >
                <span className={style.popoverName} >
                  {" "}
                 <SentimentVeryDissatisfiedIcon sx={{fontSize: '17px'}}/> Not interested in this
                </span>
              </Typography>
              <Typography
                sx={{
              ...
              >
                <span className={style.popoverName} >
                  {" "}
                 <SentimentVeryDissatisfiedIcon sx={{fontSize: '17px'}}/> This trend is harmful or spammy 
                </span>
              </Typography>
            </Popover>
          </div>
